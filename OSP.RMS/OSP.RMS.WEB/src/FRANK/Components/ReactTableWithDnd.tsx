...
import newSaleData, { NewSale } from '../Datas/newSale'
...
import reportBuilderStore from '../Routes and Store/reportBuilderStore'
...
const ReactTableWithDnd = () => {
    ...
    const [rowDraggedItem, setRowDraggedItem] = React.useState<any[]>([])
    ...
    useEffect(() => {
        ...
        if (currentItem) {
            ...
            if (!isVisble) {
                rowDraggedItem.splice(rowDraggedItem.indexOf(currentItem), 1), setRowDraggedItem(rowDraggedItem)
                setcurrentItem('')

            } else {
                if (rowDraggedItem.includes(currentItem)) {
                    rowDraggedItem.splice(rowDraggedItem.indexOf(currentItem), 1), setRowDraggedItem(rowDraggedItem)
                    setcurrentItem('')
                } else {
                    setRowDraggedItem([...rowDraggedItem, currentItem])
                    setcurrentItem('')
                }
            }
        }
                ...
                <div>
                    <SimpleGrid columns={2} spacingX='10px' spacingY='10px' padding={1} >
                        ...
                        <Box
                            ...
                            >
                                <DraggedItem item={rowDraggedItem} />
                            </Box>
                        </Box>
                        <Box
                            shadow="md"
